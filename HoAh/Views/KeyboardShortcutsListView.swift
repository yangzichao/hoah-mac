...
struct KeyboardShortcutsListView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            Divider()
                .overlay(theme.separatorColor.opacity(0.5))
            ...
            ScrollView {
                LazyVGrid(columns: [
                    ...
                    ShortcutCard(
                        icon: "wand.and.stars",
                        iconColor: .pink,
                        title: "Paste Last Transcription (AI Action)",
                        subtitle: "Paste AI Action result or original if unavailable"
                    ) {
            ...
            .background(
                LinearGradient(
                    gradient: Gradient(colors: [
                        ...
                        theme.controlBackground.opacity(0.3)
                    ]),
                    startPoint: .top,
                    endPoint: .bottom
                )
...
private struct ShortcutCard<Content: View>: View {
    ...
    var body: some View {
        ...
        .background(
            RoundedRectangle(cornerRadius: 10, style: .continuous)
                .fill(
                    LinearGradient(
                        gradient: Gradient(colors: [
                            theme.controlBackground.opacity(0.7),
        ...
        .overlay(
            RoundedRectangle(cornerRadius: 10, style: .continuous)
                .strokeBorder(
                    LinearGradient(
                        gradient: Gradient(colors: [
                            theme.separatorColor.opacity(0.5),
                            theme.separatorColor.opacity(0.3)
                        ]),
                        startPoint: .top,
                        endPoint: .bottom
                    ),
        ...
        .shadow(color: theme.shadowColor.opacity(0.2), radius: 4, x: 0, y: 2)
    }
}
...
private struct KeyBadge: View {
    ...
    var body: some View {
        Text(text)
            ...
            .foregroundColor(isEnabled ? .primary : theme.textMuted)
            ...
            .background(
                RoundedRectangle(cornerRadius: 6, style: .continuous)
                    .fill(
                        LinearGradient(
                            gradient: Gradient(colors: [
                                theme.controlBackground.opacity(isEnabled ? 0.9 : 0.6),
                                theme.controlBackground.opacity(isEnabled ? 0.7 : 0.5)
                            ]),
                            startPoint: .top,
                            endPoint: .bottom
                        )
            ...
            .overlay(
                RoundedRectangle(cornerRadius: 6, style: .continuous)
                    .strokeBorder(
                        theme.separatorColor.opacity(isEnabled ? 0.4 : 0.2),
                        lineWidth: 1
                    )
            )
            .shadow(color: theme.shadowColor.opacity(isEnabled ? 0.15 : 0.05), radius: 2, x: 0, y: 1)
...
private struct HotkeyBadge: View {
    ...
    var body: some View {
        Text(text)
            ...
            .background(
                RoundedRectangle(cornerRadius: 6, style: .continuous)
                    .fill(
                        LinearGradient(
                            gradient: Gradient(colors: [
                                theme.controlBackground.opacity(0.9),
                                theme.controlBackground.opacity(0.7)
                            ]),
                            startPoint: .top,
                            endPoint: .bottom
            ...
            .overlay(
                RoundedRectangle(cornerRadius: 6, style: .continuous)
                    .strokeBorder(theme.separatorColor.opacity(0.4), lineWidth: 1)
            )
            .shadow(color: theme.shadowColor.opacity(0.15), radius: 2, x: 0, y: 1)
    }
}
...
private struct NotSetBadge: View {
    ...
    var body: some View {
        Text("Not Set")
            ...
            .background(
                RoundedRectangle(cornerRadius: 6, style: .continuous)
                    .fill(theme.controlBackground.opacity(0.3))
            )
            .overlay(
                RoundedRectangle(cornerRadius: 6, style: .continuous)
                    .strokeBorder(theme.separatorColor.opacity(0.25), lineWidth: 1)
            )
    }
}
