...
class ElevenLabsTranscriptionService {
    ...
    func transcribe(audioURL: URL, model: any TranscriptionModel) async throws -> String {
        guard let apiKey = CloudAPIKeyManager.shared.activeKey(for: "ElevenLabs")?.value, !apiKey.isEmpty else {
    ...
    private func createRequestBody(audioURL: URL, modelName: String, boundary: String) throws -> Data {
        ...
        switch modelName {
        case "scribe_v2_batch":
            resolvedModelName = "scribe_v2"
        default:
        ...
        body.append(formField: "model_id", value: resolvedModelName, boundary: boundary)
